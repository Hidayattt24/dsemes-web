...
export function MealHistoryCard({ logs }: MealHistoryCardProps) {
  // Let's calculate donut progress: 1500 / 1800 kcal = 83%
  const target = 1800;
  const current = 1250; // Siti Aminah's daily summary is 1250 kcal
      ...
      <div className="flex items-center gap-6 mb-6">
        ...
        <div className="relative w-28 h-28 flex items-center justify-center flex-shrink-0">
          ...
          <div className="absolute flex flex-col items-center justify-center">
            <span className="text-lg font-bold text-[#1A202C] leading-none">1.250</span>
            <span className="text-[10px] text-[#718096] mt-1">/ 1.8k kcal</span>
          </div>
        </div>

        <div>
          <p className="text-sm font-semibold text-[#1A202C] mb-1.5">Asupan Kalori Harian</p>
